...
import SimpleFilterPanel, { FilterCriteria } from '../components/SimpleFilterPanel';
...
const Index = () => {
  ...
  const handleMapClick = (clickData: { lat: number; lng: number; address?: string; loading?: boolean }) => {
    setClickInfo(clickData);
  };
            ...
            {selectedLocation && (
              <div className="bg-card rounded-lg border border-border shadow-sm p-4">
                ...
                <div className="text-xs space-y-1">
                  ...
                  <p><strong>Crop:</strong> {selectedLocation.cropType}</p>
                  <p><strong>Soil:</strong> {selectedLocation.soilType}</p>
                  <p><strong>Fertility:</strong> {selectedLocation.fertility}</p>
                  <p><strong>NDVI:</strong> {selectedLocation.ndvi}</p>
                </div>
              </div>
            )}
          </div>
