...
const GISMap: React.FC<GISMapProps> = ({ selectedGeometry, onGeometrySelect, onMapClick }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Add click event listener for coordinates and reverse geocoding
      map.on('click', async (e) => {
        const { lat, lng } = e.latlng;
        
        console.log(`Clicked at: ${lat.toFixed(6)}, ${lng.toFixed(6)}`);
        
        // Update panel with coordinates immediately
  ...
  // Handle selected geometry changes
  useEffect(() => {
